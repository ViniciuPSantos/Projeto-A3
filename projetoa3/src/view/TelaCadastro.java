...
public class TelaCadastro extends JFrame{
    public TelaCadastro(){
        ...
        emailField.setBounds(100, 40, 240, 25);

        JLabel telefoneLabel = new JLabel("Telefone:");
        telefoneLabel.setBounds(10, 70, 80, 25);
        JTextField telefoneField = new JTextField();
        telefoneField.setBounds(100, 70, 240, 25);

        JLabel senhaLabel = new JLabel("Senha:");
        senhaLabel.setBounds(10, 100, 80, 25);
        JPasswordField senhaField = new JPasswordField();
        senhaField.setBounds(100, 100, 240, 25);

        JLabel confirmarSenhaLabel = new JLabel("Confirmar Senha:");
        confirmarSenhaLabel.setBounds(10, 130, 120, 25);
        JPasswordField confirmarSenhaField = new JPasswordField();
        confirmarSenhaField.setBounds(120, 130, 240, 25);
        ...
        cadastrarBtn.setBounds(10, 220, 350, 25);

        JButton cancelarButton = new JButton("Cancelar");
        cancelarButton.setBounds(10, 250, 350, 25);

        JButton btnJaTemCadastro = new JButton("Já tem cadastro? Faça login");
        btnJaTemCadastro.setBounds(10, 280, 350, 25);

        JButton btnBazar = new JButton("Cadastre seu bazar");
        btnBazar.setBounds(10, 310, 350, 25);

        JCheckBox mostrarSenhaCheckBox = new JCheckBox("Mostrar Senha");
        mostrarSenhaCheckBox.setBounds(100, 160, 150, 25);
        ...
        cadastrarBtn.addActionListener(e -> {
            ...
            Pattern emailPattern = Pattern.compile("^[\\w-\\.]+@(gmail\\.com|hotmail\\.com|outlook\\.com)$");
            ...
            if (dao.cadastrarUsuario(nome, email, senha, telefone)) {
        ...
        btnJaTemCadastro.addActionListener(e -> {
            new TelaLogin().setVisible(true);
            dispose();
        });
        ...
        btnBazar.addActionListener(e -> {
            TelaCadastroBazar telaCadastroBazar = new TelaCadastroBazar();
            telaCadastroBazar.setVisible(true);
            dispose();
        });
